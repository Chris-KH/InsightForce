  ...
  return (
    ...
    >
      <Card className="relative overflow-hidden rounded-3xl border-primary/20 bg-linear-to-br from-card via-card/96 to-primary/8">
        <motion.div
          className="pointer-events-none absolute -top-14 -left-16 size-56 rounded-full bg-primary/12 blur-3xl"
          animate={{
            x: [0, 14, 0],
            y: [0, -10, 0],
        ...
        />
        <motion.div
          className="pointer-events-none absolute right-0 -bottom-20 size-64 rounded-full bg-chart-2/16 blur-3xl"
          animate={{ x: [0, -16, 0], y: [0, 8, 0], opacity: [0.2, 0.32, 0.2] }}
          transition={{
            duration: 13,
            delay: 0.9,
            repeat: Infinity,
        ...
        <CardContent className="relative py-5">
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
            ...
            <motion.div
              className="space-y-4 rounded-2xl border border-primary/20 bg-background/45 p-4"
              initial={{ opacity: 0, x: 14 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{
